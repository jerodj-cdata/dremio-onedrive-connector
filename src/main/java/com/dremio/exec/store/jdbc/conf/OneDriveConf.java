...
@SourceType(value = "OneDriveARP", label = "OneDrive",uiConfig = "onedrive-layout.json")
public class OneDriveConf extends AbstractArpConf<OneDriveConf> {
  private static final String ARP_FILENAME = "arp/implementation/onedrive-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.onedrive.OneDriveDriver";
